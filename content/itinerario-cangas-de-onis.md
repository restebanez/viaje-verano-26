...
Familia con niño de 6 años y medio · base en Cangas de Onís · planes de naturaleza
...
En julio no se puede pedir estar solos, pero sí evitar la *locura*. Tres reglas que
funcionan casi siempre:

1. **Madrugar gana.** Llegar a un sitio "famoso" antes de las 9:30–10:00 cambia
   por completo la experiencia (sitio para aparcar + senda y poza casi vacías).
   La gente y los autobuses llegan a media mañana.
2. **Entre semana mejor.** Vuestros días fuertes (martes, miércoles, jueves) son
   laborables → menos gente que el fin de semana.
3. **Semáforo de cada sitio:** 🟢 tranquilo · 🟡 hay gente pero llevadero ·
   🔴 masificado (madrugar o ir a la alternativa).

> **Wikiloc:** descarga el track **y el mapa offline** en la app *antes* de salir
> (en los valles la cobertura es intermitente).
...
## 🏆 Ranking (baño natural + caminata arbolada + máx. 3 h + seguridad + calma)

1. **Río Casaño (hasta la Batuda)** — mejor equilibrio y **el más tranquilo**:
   sombra, casi llano, seguro, con pozas. (Baño = chapuzón más que natación.)
...
**Descartado con niño:**
- **Ruta del Cares** — desfiladero tallado y expuesto; con un niño de 6 años,
  **mejor evitar**. Mismo "espíritu de garganta" pero seguro y tranquilo → **Casaño**.
- **Lagos de Covadonga** como plan principal — restricción de coche (lanzadera),
...
- **Escarpines / zapatillas de agua** (clave: rocas resbaladizas en pozas y playa)
- Bañadores + toalla de secado rápido + muda para el niño
- Calzado de trekking con suela (para Casaño/Olla; **no chanclas** en sendas)
- Agua y snacks/picnic · gorra y crema solar · repelente de insectos
- Botiquín pequeño · bolsa estanca para el móvil
- Efectivo para parkings y sidrerías
- **Móvil:** tracks de Wikiloc + mapa **descargados offline** antes de salir

---

## Datos verificados (jun 2026)

- **Lagos de Covadonga:** acceso **regulado** del 1 jun al 18 oct (con excepciones
  puntuales) — en los días de vuestro viaje (20–23 jul) **no contéis con subir en
  coche particular**; hay lanzadera cada 30 min (7:40–19:00), 9 €/adulto, 3,50 €/<12,
  2 € parking (alsa.es). La **tarde del 24 jul** se abre a coches, pero no os sirve
  por el vuelo.
- **Santuario de Covadonga:** acceso en coche libre todo el año; parking justo,
  mejor antes de 9:30.
- **Cangas → Aeropuerto de Asturias:** 107 km, ~1 h 15–1 h 20.
- **Cuevas del Mar:** socorrista en verano; se llena antes de las 11:00; cuevas con
  marea baja. Olla de San Vicente: parking ~15 plazas, masificación alta en julio
  (alternativa: aparcar en Miyares / pozas previas del Dobra).

Fuentes: Plan de Acceso a los Lagos 2026 (picosdeeuropa.com, buslagoscovadonga.es),
guiadeasturias.com, xn--cangasdeons-xcb.com (santuario), calcularruta.com / rome2rio
(Cangas y Colunga → aeropuerto), vetturinos.com / villadellanes.com (Cuevas del Mar),
turismoasturias.es (La Griega), turismocangasdeonis.es / playasasturias.com (Aballe),
queverenasturias.es (La Pesanca está en Piloña), siguiendolasenda.es /
escapadarural.com (Olla, masificación y alternativas), Wikiloc, Turismo Asturias.
